...
describe('public/app/navigation function Init()', () => {
  ...
  describe('Menu:Show Message Handler', () => {
    ...
    it('should preserve foo class on main menu node', async () => {
      Navigation.Init()
      const handler = PubSub.subscribers['MENU:SHOW']?.pop()
      assert(handler !== undefined, 'handler must have a value')
      menuNode?.classList.add('foo')
    ...
    it('should preserve bar class on main menu node', async () => {
      Navigation.Init()
      const handler = PubSub.subscribers['MENU:SHOW']?.pop()
      assert(handler !== undefined, 'handler must have a value')
      menuNode?.classList.add('foo')
    ...
    it('should preserve baz class on main menu node', async () => {
      Navigation.Init()
      const handler = PubSub.subscribers['MENU:SHOW']?.pop()
      assert(handler !== undefined, 'handler must have a value')
      menuNode?.classList.add('foo')
  ...
  describe('Menu:Hide Message Handler', () => {
    ...
    it('should preserve foo class on hidden main menu node', async () => {
      Navigation.Init()
      const handler = PubSub.subscribers['MENU:HIDE']?.pop()
      assert(handler !== undefined, 'handler must have a value')
      menuNode?.classList.add('foo')
    ...
    it('should preserve bar class on hidden main menu node', async () => {
      Navigation.Init()
      const handler = PubSub.subscribers['MENU:HIDE']?.pop()
      assert(handler !== undefined, 'handler must have a value')
      menuNode?.classList.add('foo')
    ...
    it('should preserve baz class on hidden main menu node', async () => {
      Navigation.Init()
      const handler = PubSub.subscribers['MENU:HIDE']?.pop()
      assert(handler !== undefined, 'handler must have a value')
      menuNode?.classList.add('foo')
